...
suspend fun main() {
    ...
    val pluginInstance = GearBlade.INSTANCE

    pluginInstance.load() // 主动加载插件, Console 会调用 GearBlade.onLoad
    pluginInstance.enable() // 主动启用插件, Console 会调用 GearBlade.onEnable
